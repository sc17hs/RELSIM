...
for files in os.listdir("../quran"):
        if files.endswith('.txt'):
                qurandir.append(files)
...
def quranverses():
        ...
        for i in range(len(qurandir)):
                file =  open('../quran/'+str(qurandir[1]),encoding="utf-8")
                verse2 = file.readlines()
                quran.append(verse2)
                file.close()
...
zero = "".join(i for i in sentence if i not in punctuation)
zero = zero.split()
resultwords  = [word for word in zero if word.lower() not in stopwords]
...
#print(join)
join2 = join2.replace('\n',' ')
zero2 = "".join(i for i in join2 if i not in punctuation)
zero2 = "".join(i for i in zero2 if not i.isdigit())
zero2 = zero2.split()
resultwords2  = [word for word in zero2 if word.lower() not in stopwords]
result2 = ' '.join(resultwords2) 

#doc1 = word_tokenize(result)
#doc2 = word_tokenize(result2)
doc1 = nlp(result)
doc2 = nlp(result2)
print(' ')
print(doc1)
